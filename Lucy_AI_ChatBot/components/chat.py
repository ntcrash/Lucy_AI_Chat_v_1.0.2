...
from Lucy_AI_ChatBot.components import loading_icon
from Lucy_AI_ChatBot.state import State, QA
...
def action_bar() -> rx.Component:
    ...
    return rx.center(
        rx.vstack(
            ...
            rx.text(
                "Lucy AI Chat GPT may return factually incorrect or misleading responses. Use discretion.",
                text_align="center",
                font_size=".75em",
